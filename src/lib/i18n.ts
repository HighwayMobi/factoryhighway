...
const translations = {
  ru: {
    ...
    cp_upgradeNote: "Новый тариф будет применён на следующий день. Абонентская плата €{price} будет списана сразу.",
  ...
  en: {
    ...
    cp_upgradeNote: "The new plan will be applied the next day. Monthly fee €{price} will be charged immediately.",
