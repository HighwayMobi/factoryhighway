...
const translations = {
  ru: {
    ...
    cp_confirmText1: "С вашего баланса будет списано",
    cp_confirmText2: "в ближайший расчётный день",
  ...
  en: {
    ...
    cp_confirmText1: "Your balance will be charged",
    cp_confirmText2: "on the next billing date",
